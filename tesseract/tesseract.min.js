                ...
                ;(e.blobSlice =
                        ...
                        function (t) {
                          ...
                          if (65496 === f.getUint16(0)) {
                            for (
                              ;
                              p < d &&
                              (((a = f.getUint16(p)) >= 65504 && a <= 65519) || 65534 === a);
                  ...
                  (e.replaceHead = function (t, r, n) {
                    e.parseMetaData(
                      ...
                      function (o) {
                        n(
                          new Blob([r, e.blobSlice.call(t, o.imageHead.byteLength)], {
                            type: 'image/jpeg',
                          }),
                        )
                      },
          ...
          R = function (e, t) {
            return j(
              f({
                id: t,
                action: 'FS',
                payload: { method: 'readFile', args: [e, { encoding: 'utf8' }] },
              }),
            )
          },
          I = function (e, t) {
                ...
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          null !== x && (b(x), (x = null)), e.abrupt('return', Promise.resolve())
                        )
                      case 2:
                      case 'end':
                        return e.stop()
                  ...
                  (e.scale = function (t, r, n) {
                    ...
                    if (
                      (m &&
                        ...
                        r.sourceWidth
                          ? ((s = r.sourceWidth),
                            void 0 !== r.right && void 0 === r.left && (l = y - s - r.right))
                          : (s = y - l - (r.right || 0)),
                        r.sourceHeight
                          ? ((u = r.sourceHeight),
                            void 0 !== r.bottom && void 0 === r.top && (f = b - u - r.bottom))
                          : (u = b - f - (r.bottom || 0)),
                        (v = s),
                        (w = u)),
                      (o = r.maxWidth),
                      ...
                      m && o && i && r.crop
                        ? ((v = o),
                          ...
                          (h = s / u - o / i) < 0
                            ? ((u = (i * s) / o),
                              void 0 === r.top && void 0 === r.bottom && (f = (b - u) / 2))
                            : h > 0 &&
                              ((s = (o * u) / i),
                              void 0 === r.left && void 0 === r.right && (l = (y - s) / 2)))
              ...
              typeof (n = function (e) {
                ...
                function n(e, t, n, o, i, a) {
                  ...
                  if (d) {
                    if (
                      !(
                        (s = (c = d.size * i) > 4 ? t + e.getUint32(n + 8, a) : n + 8) + c >
                        e.byteLength
                      )
                    ) {
                                ...
                                i.exif[513] &&
                                  ...
                                  (i.exif[513] = (function (e, t, r) {
                                    if (r && !(t + r > e.byteLength))
                                      return new Blob([e.buffer.slice(t, t + r)], {
                                        type: 'image/jpeg',
                                      })
                ...
                return regeneratorRuntime.wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        for (n = a.length, o = new Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++)
                          o[i - 1] = a[i]
                    ...
                    for (e in o)
                      if (Object.prototype.hasOwnProperty.call(o, e))
                        if ((r = t.privateIFDs[e]))
                          for (e in (n = o[e]))
                            Object.prototype.hasOwnProperty.call(n, e) && (r.map[n[e]] = Number(e))
